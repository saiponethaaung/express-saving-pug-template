...
exports.ledger_list_get = function (req: any, res: Response, next: NextFunction) {
    async.parallel({
        ledgerList: function (callback: Function) {
...
exports.ledger_create_form_get = function (req: Request, res: Response, next: NextFunction) {
...
function ledgerCreateResponse(res: Response, user: any, errors: any) {
    res.render('page/ledger/form', { title: 'Create ledger', user: user, errors: errors });
}

exports.ledger_summary = function (req: any, res: Response, next: NextFunction) {
    async.parallel({
        ledger: function (callback: Function) {
            Ledger.findById(req.params.id)
                .exec(callback);
        },
        entries: function (callback: Function) {
            Record.find({ ledger: req.params.id })
                .sort({ 'createdAt': -1 })
                .exec(callback);
        },
        income: function (callback: Function) {
            Record.aggregate([
                {
                    $match: {
        ...
        expense: function (callback: Function) {
            Record.aggregate([
                {
                    $match: {
                        ledger: new mongoose.Types.ObjectId(req.params.id),
...
exports.ledger_detail_get = function (req: any, res: Response, next: NextFunction) {
    async.parallel({
        ledger: function (callback: Function) {
            Ledger.findById(req.params.id)
                .exec(callback);
...
exports.ledger_entry_get = function (req: any, res: Response, next: NextFunction) {
    async.parallel({
        ledger: function (callback: Function) {
            Ledger.findById(req.params.id)
                .exec(callback);
...
exports.ledger_entry_update_get = function (req: any, res: Response, next: NextFunction) {
    async.parallel({
        ledger: function (callback: Function) {
            Ledger.findById(req.params.id)
                .exec(callback);
        },
        entry: function (callback: Function) {
...
exports.ledger_entry_update_post = [
    ...
    (req: any, res: Response, next: NextFunction) => {
        ...
        async.parallel({
            ...
            results.entry.save(function (err: any) {
                if (err) { return next(err); }
...
exports.ledger_entry_delete = (req: any, res: Response, next: NextFunction) => {
    async.parallel({
        ledger: function (callback: Function) {
            Ledger.findById(req.params.id)
                .exec(callback);
        ...
        results.entry.delete(function (err: any) {
            if (err) { return next(err); }
